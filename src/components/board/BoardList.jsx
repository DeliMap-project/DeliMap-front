                                                ...
                                                {board_list.map(boardList => {
                                                    return (
                                                        <div className={'board_list_wrap'} key={boardList.board_no}>
                                                            ...
                                                            <div
                                                                className="board_list_phone">{boardList.board_phone}</div>
                                                            ...
                                                            <div className="board_list_hashtag">
                                                                ...
                                                                <span
                                                                    onClick={() => hashtagBoardList(boardList.review_hashtag.split(', ')[0])}>{boardList.review_hashtag.split(', ')[0]}</span>
                                                                <span
                                                                    onClick={() => hashtagBoardList(boardList.review_hashtag.split(', ')[1])}>{boardList.review_hashtag.split(', ')[1]}</span>
                                                                <span
                                                                    onClick={() => hashtagBoardList(boardList.review_hashtag.split(', ')[2])}>{boardList.review_hashtag.split(', ')[2]}</span>
                                                                <span
                                                                    onClick={() => hashtagBoardList(boardList.review_hashtag.split(', ')[3])}>{boardList.review_hashtag.split(', ')[3]}</span>
                                                                <span
                                                                    onClick={() => hashtagBoardList(boardList.review_hashtag.split(', ')[4])}>{boardList.review_hashtag.split(', ')[4]}</span>
                                                            </div>
                                                            <div className="board_list_img"><img
                                                                src="/src/assets/고양이1.jpg" alt="이미지"/></div>
